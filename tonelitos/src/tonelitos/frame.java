...
public class frame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btEditableON = new javax.swing.JToggleButton();
        jLabel1 = new javax.swing.JLabel();
        btEditableOFF = new javax.swing.JToggleButton();
        ...
        panelNodos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                panelNodosMouseClicked(evt);
            }
        });

        javax.swing.GroupLayout panelNodosLayout = new javax.swing.GroupLayout(panelNodos);
        panelNodos.setLayout(panelNodosLayout);
        panelNodosLayout.setHorizontalGroup(
            panelNodosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 830, Short.MAX_VALUE)
        );
        panelNodosLayout.setVerticalGroup(
            panelNodosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 480, Short.MAX_VALUE)
        );

        NewMap.getContentPane().add(panelNodos);
        panelNodos.setBounds(30, 30, 830, 480);
        ...
        img_map1.setBounds(30, 30, 830, 480);
        ...
        NewMap.getContentPane().add(jPanel5);
        jPanel5.setBounds(520, 210, 100, 100);

        buttonGroup1.add(btEditableON);
        btEditableON.setText("Editable");
        NewMap.getContentPane().add(btEditableON);
        btEditableON.setBounds(325, 530, 130, 23);
        ...
        buttonGroup1.add(btEditableOFF);
        btEditableOFF.setText("No Editable");
        NewMap.getContentPane().add(btEditableOFF);
        btEditableOFF.setBounds(480, 530, 120, 23);
        ...
        jLabel17.setBounds(20, 20, 1090, 560);
    ...
    private void panelNodosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_panelNodosMouseClicked
        Pintar pinta = new Pintar();
        if (btEditableON.isSelected()) {
            
            Graphics g = panelNodos.getGraphics();
            int x = evt.getX();
            int y = evt.getY();
            int cantidaddenodos = grafo.getLista().size() + 1;
            String letra = "";
            if (cantidaddenodos == 1) {
                letra = "A";
            } else if (cantidaddenodos == 2) {
                letra = "B";
            } else if (cantidaddenodos == 3) {
                letra = "C";
            } else if (cantidaddenodos == 4) {
                letra = "D";
            } else if (cantidaddenodos == 5) {
                letra = "E";
            } else if (cantidaddenodos == 6) {
                letra = "F";
            } else if (cantidaddenodos == 7) {
                letra = "G";
            } else if (cantidaddenodos == 8) {
                letra = "H";
            }
            grafo.addNodo(new Nodo(letra, x, y));
            

            pinta.DibujarCirculo(g, x, y, letra);
            
            
        } else if (btEditableOFF.isSelected()) {
            int equis = evt.getX(), ye = evt.getY();
            //GrafoEnTexto.setText(GrafoEnTexto.getText() + "\n EVT X: " + equis + " EVT Y:" + ye);
            cicDerechoSobreNodo(equis, ye);
            System.out.println("equis: "+equis+" ye:"+ye);
        }
        ...
        if (NodosSeleccionados == 2) {
            ...
            grafo.getLista().get(Nodo1).addArista(grafo.getLista().get(Nodo2), peso);
            /*grafo.setMatrizAd(grafo.getLista().get(Nodo1).getNumero(), grafo.getLista().get(Nodo2).getNumero(), 1);
            grafo.setMatrizAd(grafo.getLista().get(Nodo2).getNumero(), grafo.getLista().get(Nodo1).getNumero(), 1);
            grafo.setMatrizCo(grafo.getLista().get(Nodo1).getNumero(), grafo.getLista().get(Nodo2).getNumero(), peso);
            grafo.setMatrizCo(grafo.getLista().get(Nodo2).getNumero(), grafo.getLista().get(Nodo1).getNumero(), peso);*/
            pinta.DibujarLinea(panelNodos.getGraphics(), grafo.getLista().get(Nodo1).getX(), grafo.getLista().get(Nodo1).getY(), grafo.getLista().get(Nodo2).getX(), grafo.getLista().get(Nodo2).getY(), peso);
            pinta.DibujarCirculo(panelNodos.getGraphics(), grafo.getLista().get(Nodo1).getX(), grafo.getLista().get(Nodo1).getY(), grafo.getLista().get(Nodo1).getLetra());
            pinta.DibujarCirculo(panelNodos.getGraphics(), grafo.getLista().get(Nodo2).getX(), grafo.getLista().get(Nodo2).getY(), grafo.getLista().get(Nodo1).getLetra());
            Nodo1 = -1;
            Nodo2 = -1;
        }

    }//GEN-LAST:event_panelNodosMouseClicked

    public void cicDerechoSobreNodo(int xxx, int yyy) {
        for (int j = 0; j < grafo.getLista().size(); j++) {
           
            if ((xxx + 2) > grafo.getLista().get(j).getX() && xxx < (grafo.getLista().get(j).getX() + 13) && (yyy + 2) > grafo.getLista().get(j).getY() && yyy < (grafo.getLista().get(j).getY() + 13)) {
                if (NodosSeleccionados == 0) {
                    Nodo1 = j;
                    Pintar p = new Pintar();
                    p.clickSobreNodo(panelNodos.getGraphics(), grafo.getLista().get(j).getX(), grafo.getLista().get(j).getY(), null, Color.orange);
                    NodosSeleccionados++;
                } else {
                    Nodo2 = j;
                    Pintar p = new Pintar();
                    ...
                    if (Nodo1 == Nodo2) {
                        NodosSeleccionados = 0;
                        p.DibujarCirculo(panelNodos.getGraphics(), grafo.getLista().get(j).getX(), grafo.getLista().get(j).getY(), grafo.getLista().get(j).getLetra());
                        Nodo1 = -1;
                        Nodo2 = -2;
                    }
                }
    ...
    private javax.swing.JToggleButton btEditableOFF;
    private javax.swing.JToggleButton btEditableON;
    ...
    Lista_Aristas lista = new Lista_Aristas();
